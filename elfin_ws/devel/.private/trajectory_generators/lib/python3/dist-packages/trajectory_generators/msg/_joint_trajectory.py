...
"""autogenerated by genpy from trajectory_generators/joint_trajectory.msg. Do not edit."""
import codecs
import sys
...
class joint_trajectory(genpy.Message):
  _md5sum = "e3b6f85fdd98c8fe810307d4a919a3cf"
  _type = "trajectory_generators/joint_trajectory"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """#int64 num #Old stuff
float64[] position
float64[] velocity
