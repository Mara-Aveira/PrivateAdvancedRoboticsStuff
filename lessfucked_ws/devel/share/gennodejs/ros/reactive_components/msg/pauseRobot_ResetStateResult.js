...
class pauseRobot_ResetStateResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new pauseRobot_ResetStateResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new pauseRobot_ResetStateResult(null);
...
module.exports = pauseRobot_ResetStateResult;
