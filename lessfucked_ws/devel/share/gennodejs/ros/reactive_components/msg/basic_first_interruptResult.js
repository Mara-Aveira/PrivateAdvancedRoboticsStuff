...
class basic_first_interruptResult {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new basic_first_interruptResult(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new basic_first_interruptResult(null);
...
module.exports = basic_first_interruptResult;
