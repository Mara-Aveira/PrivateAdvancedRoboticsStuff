...
class basic_first_interruptGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new basic_first_interruptGoal(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new basic_first_interruptGoal(null);
...
module.exports = basic_first_interruptGoal;
