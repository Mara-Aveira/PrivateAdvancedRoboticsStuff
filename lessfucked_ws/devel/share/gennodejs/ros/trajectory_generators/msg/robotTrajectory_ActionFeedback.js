...
let robotTrajectory_Feedback = require('./robotTrajectory_Feedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class robotTrajectory_ActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new robotTrajectory_Feedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = robotTrajectory_Feedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new robotTrajectory_ActionFeedback(null);
    ...
    data.feedback = robotTrajectory_Feedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new robotTrajectory_ActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = robotTrajectory_Feedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new robotTrajectory_Feedback()
    }
...
module.exports = robotTrajectory_ActionFeedback;
