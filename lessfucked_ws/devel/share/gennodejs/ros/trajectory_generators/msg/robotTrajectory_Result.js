...
class robotTrajectory_Result {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new robotTrajectory_Result(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new robotTrajectory_Result(null);
...
module.exports = robotTrajectory_Result;
