...
class jointspace_trajectory {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new jointspace_trajectory(null);
  ...
  static datatype() {
    ...
    return 'trajectory_generators/jointspace_trajectory';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new jointspace_trajectory(null);
...
module.exports = jointspace_trajectory;
