...
if("TRUE" STREQUAL "TRUE")
  set(ar_track_alvar_msgs_SOURCE_PREFIX /home/marea/lessfucked_ws/src/edu-elfin_simulation/ar_track_alvar_msgs)
  set(ar_track_alvar_msgs_DEVEL_PREFIX /home/marea/lessfucked_ws/devel)
  ...
  set(ar_track_alvar_msgs_INSTALL_PREFIX /home/marea/lessfucked_ws/install)
...
if(NOT "/home/marea/lessfucked_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ar_track_alvar_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marea/lessfucked_ws/src/edu-elfin_simulation/ar_track_alvar_msgs/${idir}'.  ${_report}")
    endif()
