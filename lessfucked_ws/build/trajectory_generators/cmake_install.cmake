# Install script for directory: /home/marea/lessfucked_ws/src/trajectory_generators
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/trajectory_generators/cmake" TYPE FILE FILES "/home/marea/lessfucked_ws/build/trajectory_generators/catkin_generated/installspace/trajectory_generators-msg-paths.cmake")
endif()
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/pkgconfig" TYPE FILE FILES "/home/marea/lessfucked_ws/build/trajectory_generators/catkin_generated/installspace/trajectory_generators.pc")
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/trajectory_generators/cmake" TYPE FILE FILES "/home/marea/lessfucked_ws/build/trajectory_generators/catkin_generated/installspace/trajectory_generators-msg-extras.cmake")
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/trajectory_generators/cmake" TYPE FILE FILES
    "/home/marea/lessfucked_ws/build/trajectory_generators/catkin_generated/installspace/trajectory_generatorsConfig.cmake"
    "/home/marea/lessfucked_ws/build/trajectory_generators/catkin_generated/installspace/trajectory_generatorsConfig-version.cmake"
    )
endif()

if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/trajectory_generators" TYPE FILE FILES "/home/marea/lessfucked_ws/src/trajectory_generators/package.xml")
endif()
